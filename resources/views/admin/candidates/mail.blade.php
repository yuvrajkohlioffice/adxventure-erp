...
<!DOCTYPE html>
   ...
   <body>
      ...
      <h1 style="padding-left: 5pt;text-indent: 0pt;text-align: left;">Offer:{{$data['role']}} </h1>
      <h1 style="padding-left: 5pt;text-indent: 0pt;text-align: left;">Date:  {{ \Carbon\Carbon::parse($data['created_at'])->format('d-m-Y') }}</h1>
      <h1 style="padding-left: 5pt;text-indent: 0pt;text-align: left;">Mr.{{ ucfirst($data['name']) }}</h1>
      ...
      <h1 style="padding-left: 5pt;text-indent: 0pt;line-height: 13pt;text-align: left;">{{ ucfirst($data['name']) }}</h1>
      <p style="text-indent: 0pt;text-align: left;"><br /></p>
      <p style="padding-left: 5pt;text-indent: 0pt;text-align: left;">Thank you for exploring career opportunities with AdxVenture. You have successfully completed our initial selection process and we are pleased to offer you the employment. <b>This offer is based on your profile, and performance in the selection process. You have been selected for the position of {{$data['role']}} at Adxventure - Dehradun.</b></p>
      <p style="text-indent: 0pt;text-align: left;"><br /></p>
      @if($data['before_ctc'] == null)
      <p style="padding-left: 5pt;text-indent: 0pt;text-align: left;">Your gross salary including all benefits will be Rs. {{$data['ctc']}}/- per month,</p>
      @else
      <p style="padding-left: 5pt;text-indent: 0pt;text-align: left;">Your gross salary including all benefits will be Rs. {{$data['before_ctc']}}/- per month, for first {{$data['before_ctc_period']}} months after that your salary will be {{$data['after_ctc']}}/- per month, for next {{$data['after_ctc_period']}} months. </p>
      @endif
      <p style="text-indent: 0pt;text-align: left;"><br /></p>
