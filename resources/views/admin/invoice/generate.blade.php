    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <a class="btn btn-primary btn-sm" href="{{route('pdf.generate',['clientId'=>$client->id])}}"
                    target="_blank">Send
                    Mail</a>
                    <a href="{{ route('work.Index', $client->id) }}" class="btn btn-success btn-sm"><i
                ...
                <!--Gst Modal Open -->
                <div class="modal" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title" id="exampleModalCenterTitle">GST</h5>
                            ...
                            <form action="" method="GET" id="gstForm">

                                <div class="modal-body">

                                    <div class="mb-3 mt-3">

                                        <label for="email" class="form-label">GST Change:</label>

                                        <input type="number" min="1" max="28" class="form-control col-md-6" id="email"
                                            placeholder="Enter GST" value="{{ request()->gst_price }}" name="gst_price"
                                            required>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="submitBtn" class="btn btn-primary btn-md"
                                        onclick="confirmResend(event)">Submit</button>
                                    ...
                                    <main>
                                        <div class="row contacts">
                                            <div class="col invoice-to">
                                                ...
                                                <h5 class="to">{{$client->project->name ?? 'Company Name : N/A'}}</h5>
                                                <div class="address"><strong>Add:
                                                    </strong>{{$client->client->address ?? 'Client Address : N/A'}}
                                                </div>
                                                <div class="email">Email: <a
                                                        href="{{$client->email ?? 0}}">{{$client->client->email ?? 'na/a' }}</a></div>
                                                <div class="email">Gst No.:
                                                    {{$client->project->gst_no ?? 'N/A'}}</div>
                                            </div>
                                            <div class="col invoice-details">
                                                ...
                                                <div class="status">Invoice Status:<strong
                                                        class="text-danger">UnPaid</strong></div>
                                            </div>
                                        </div>
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="unit text-center">{{$work->work_quality}}</td>
                                                    <td class="unit text-center">{{$work->work_price}}</td>
                                                </tr>
                                                <?php 
                                                $tot += ($work->work_price);
                                                ?>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr style="background: #fff;">
                                                    ...
                                                    <td colspan="2" rowspan="1">
                                                        <h5 style="border-bottom:1px solid ;padding: 10px 0;">
                                                            ...
                                                            <strong
                                                                style="margin-left:100px">₹{{ number_format($tot ?? 00) }}.00</strong>
                                                        </h5>
                                                        @php
                                                        $gstPrice = $client->gst ?? 18; // Default GST value
                                                        @endphp
                                                        @if($client->discount)
                                                        @php
                                                        $discount = $client->discount;
                                                        $discountPrice = ($tot * $discount) / 100;
                                                        ...
                                                        <h5 style="border-bottom:1px solid ;padding: 10px 0;">
                                                            ...
                                                            <strong
                                                                style="margin-left:100px">₹{{ number_format($discountPrice ?? 00) }}.00({{ number_format($client->discount ?? 00) }}%)</strong>
                                                        </h5>
                                                        @else
                                                        @php
                                                        $percentValue = ($tot * $gstPrice) / 100;
                                                        ...
                                                        @endif
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            <strong>GST: {{ $gstPrice }}%</strong>
                                                            <strong style="margin-left:82px">
                                                                ₹{{ number_format($percentValue ?? 00) }}.00</strong>
                                                        </h5>
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            <strong>Advance: </strong>
                                                            <strong style="margin-left:85px">
                                                                ₹{{ number_format($advanced ?? 00) }}.00</strong>
                                                        </h5>
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            <strong>Balance: </strong>
                                                            <strong
                                                                style="margin-left:90px">₹{{ number_format((($tot + $percentValue) - ($advanced ?? 00))) }}.00</strong>
                                                        </h5>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div class="notice"><b>Bank Name</b>: State Bank of India</div>
                                                        <div class="notice"><b>Account Holder Name</b>: Adxventure LLP</div>
                                                    </td>
                                                    <td colspan="1">GST {{(request()->gst_price ?? '9')}}%</td>
                                                    <td>₹ {{($tot / 100) * (request()->gst_price ?? '9')}}.00</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2"></td>
                                                    <td colspan="1">GRAND TOTAL</td>
                                                    <td>₹{{number_format($tot + ($tot / 100) * (request()->gst_price ?? '9') )}}.00
                                                    </td>
                                                </tr>
                                                @endif -->
                                                <tr style="background:#fff;">
