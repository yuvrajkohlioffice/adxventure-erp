                                    ...
                                    <main>
                                        <div class="row contacts">
                                            ...
                                            <div class="col invoice-details">
                                                ...
                                                <div class="date">Date of Bill : {{date('d/m/Y', strtotime($invoice->created_at))}}</div>
                                            </div>
                                        </div>
                                        <!-- Work Table  -->
                                                    ...
                                                    <td colspan="2" rowspan="1">
                                                        ...
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            Paid Amount :<span><strong
                                                                style="float: right">{{$invoice->currency}} {{number_format(($invoice->pay_amount ?? '00'))}}.00</strong></span> 
                                                        </h5>
                                                    </td>
                                                </tr>
                                                <tr style="background:#fff;">
        ...
        <div class="modal-dialog  modal-dialog-centered ">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <form class="ajax-form" data-action="{{route('bill',[$invoice->id])}}" data-method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label">Payment Link / Invoice Send Via <span class="text-danger" >*</span> </label>
                                        <div class="form-check">
