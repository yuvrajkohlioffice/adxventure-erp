                        ...
                        <table>
                            <tr>
                                ...
                                <td style="text-align: right;" colspan="2">
                                    <h3 style="margin: 0; color: #3989c6;">Quotation <br>#00{{ $invoice->id }}/{{ date('M', strtotime($invoice->created_at)) }}/{{ date('Y', strtotime($invoice->created_at)) }}-{{ date('y', strtotime($invoice->created_at)) + 1 }}</h3>
                                    <div>Date of Invoice: {{ date('d/m/Y', strtotime($invoice->created_at)) }}</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td colspan="2" style="padding: 0 15px;">
                        <table>
                            ...
                            <tbody>
                                ...
                                @endif
                                    <tr>
                                        <td @if($bank->gst == 1) rowspan="3" @else rowspan="2" @endif  style="border: 1px solid #ddd;"> </td>
