        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <!-- filter Form Start -->
                        <form method="POST" action="{{route('crm.upsale.invoice')}}">
                            @csrf
                            <input type="hidden" name="client_id" value="{{$client->id}}">
                            <div class="row m-4">
                                <div class="col-md-4">
                                    <label>Client Name</label>
                                    <input class="form-control" type="text" name="client_name" value="{{$client->name}}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label>Email</label>
                                    <input class="form-control" type="email" name="client_email" value="{{$client->email}}" readonly>  
                                </div>
                                <div class="col-md-4">
                                    <label>Phone</label>
                                    <input class="form-control" type="number" name="city_phone" value="{{$client->phone_no}}" readonly>  
                                </div>
                                <div class="col-md-4 mt-3">
                                    <label>Billing Date</label>
                                    <input class="form-control" type="date" name="billing_date" value="{{old('billing_date')}}" required>  
                                </div>
                                <div class="col-md-4 mt-3">
