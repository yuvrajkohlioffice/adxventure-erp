        ...
        <div class="card info-card sales-card">
            <div class="card-body pt-4 d-flex align-items-center gap-3">
                ...
                <div class="div">
                    ...
                    <h6 class="mb-0 fs-22 text-dark mt-2" id="followups_count">{{$count['followups']}}</h6> 
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card info-card sales-card">
            <div class="card-body pt-4 d-flex align-items-center gap-3">
                ...
                <div class="div">
                    ...
                    <h6 class="mb-0 fs-22 text-dark mt-2" id="proposals_count">{{$count['proposals'] ?? 0}}</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card info-card sales-card">
                ...
                <div class="div">
                    ...
                    <h6 class="mb-0 fs-22 text-dark mt-2" id="delay_count">{{$count['delay'] ?? 0}}</h6>
                </div>
            </div>
        </div>
    </div>
    <div class="col">
        <div class="card info-card sales-card">
                ...
                <div class="div">
                    ...
                    <h6 class="mb-0 fs-22 text-dark mt-2" id="reject_count">{{$count['reject']  ?? 0}}</h6>
                </div>
            </div>
        </div>
    </div>
