<script>
    ...
    window.addEventListener('load', function() {
        ...
        function EditLead(id, name, email, country, phone, city, client_category, website, domain_expire,
            lead_status, lead_source, ref_name, assigned_user, project_category) {
        ...
        function syncCountryAndPhoneCode(country) {
            ...
            var phoneCode = document.querySelector(`#country-select option[value="${country}"]`).getAttribute(
                'data-phonecode');
        ...
        function syncPhoneCode() {
            ...
            var phoneCode = document.querySelector(`#country-select option[value="${selectedCountry}"]`)
                .getAttribute('data-phonecode');
                ...
                success: function(response) {
                    ...
                    if (response.followups && response.followups.length > 0) {
                        ...
                        response.followups.forEach(function(follow) {
                            ...
                            const createdDate =
                                `${String(createdDateObj.getDate()).padStart(2, '0')}/${String(createdDateObj.getMonth() + 1).padStart(2, '0')}/${createdDateObj.getFullYear()} ${String(createdDateObj.getHours()).padStart(2, '0')}:${String(createdDateObj.getMinutes()).padStart(2, '0')}:${String(createdDateObj.getSeconds()).padStart(2, '0')}`;
                            ...
                            if (follow.next_date) {
                                ...
                                nextDate =
                                    `${String(nextDateObj.getDate()).padStart(2, '0')}/${String(nextDateObj.getMonth() + 1).padStart(2, '0')}/${nextDateObj.getFullYear()}`;
        ...
        $(document).ready(function() {
            ...
            function toggleRemarkField() {
                ...
                if ($('#call_me_tommrow').is(':checked') || $('#not_interested').is(':checked') || $(
                        '#wrong_info').is(':checked') || $('#not_pickup').is(':checked') || $(
                        '#other_company').is(':checked')) {
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.followups && response
                                    .followups.length > 0) {
                                    ...
                                    response.followups.forEach(function(
                                        follow) {
                                ...
                                if (response.pagination && response
                                    .pagination.last_page > 1) {

                                    for (let i = 1; i <= response
                            ...
                            error: function(xhr, status, error) {
                                ...
                                alert(
                                    'Error fetching follow-up data. Please try again.');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            selectBoxes.forEach(selectBox => {
                selectBox.addEventListener('change', function() {
                    if (this.id === 'lead_day') {
                        const fromDateContainer = document.getElementById(
                            'from_date_container');
                        const toDateContainer = document.getElementById(
                            'to_date_container');
