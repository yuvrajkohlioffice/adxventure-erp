<x-app-layout>
    ...
    <div class="pagetitle">
        <div id="reportrange" class="form-control" style="cursor: pointer;width: 100%; max-width:fit-content !important;float:right; border-radius:6px;padding:3.5px 6px;font-weight: 600;">
            <small>Sort By</small>&nbsp;
