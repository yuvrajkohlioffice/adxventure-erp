                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body pt-4 d-flex align-items-center gap-3">
                            ...
                            <div class="div">
                                ...
                                <h6 class="mb-0 fs-22 text-dark mt-2" id="followups_count">{{ $count['followups'] ?? 0 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body pt-4 d-flex align-items-center gap-3">
                            ...
                            <div class="div">
                                ...
                                <h6 class="mb-0 fs-22 text-dark mt-2" id="proposals_count">{{ $count['proposal'] ?? 0 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body pt-4 d-flex align-items-center gap-3">
                            ...
                            <div class="div">
                                ...
                                <h6 class="mb-0 fs-22 text-dark mt-2" id="quotation_count">{{ $count['quotation'] ?? 0 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body pt-4 d-flex align-items-center gap-3">
                            ...
                            <div class="div">
                                ...
                                <h6 class="mb-0 fs-22 text-dark mt-2" id="revenue_count">₹ {{ $count['revenue'] ?? 0 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body pt-4 d-flex align-items-center gap-3">
                            ...
                            <div class="div">
                                ...
                                <h6 class="mb-0 fs-22 text-dark mt-2" id="revenue_count">{{ $count['employee'] ?? 0 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body pt-4 d-flex align-items-center gap-3">
                            ...
                            <div class="div">
                                ...
                                <h6 class="mb-0 fs-22 text-dark mt-2" id="revenue_count">{{ $count['attandance'] ?? 0 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            @else
                                                                <img src="{{ asset($leave->users->image) }}"
