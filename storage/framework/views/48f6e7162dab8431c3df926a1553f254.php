...
<script>
    ...
    <?php if(session('alert')): ?>
        ...
        toastr.info("<?php echo e(session('alert')); ?>");

    <?php endif; ?>

    <?php if(session('toast')): ?>

        toastr.info("<?php echo e(session('toast')); ?>");

    <?php endif; ?>

    <?php if(session('notification')): ?>

        toastr.info("<?php echo e(session('notification')); ?>");
...
<?php if(session('show_late_modal')): ?>
...
<script>
   $(document).ready(function () {
    $('#lateReasonForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo e(route('submitLateReason')); ?>',
            type: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                reason: reason
...
</script><?php /**PATH /home/bookmziw/lara_tms/laravel/resources/views/components/admin/script.blade.php ENDPATH**/ ?>