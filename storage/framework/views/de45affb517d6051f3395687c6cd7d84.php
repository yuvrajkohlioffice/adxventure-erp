                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($d->status == 1): ?> 
                                            <a class="btn btn-sm btn-success" href="<?php echo e(route('departments.status',['id'=>$d->id,'status'=>0])); ?>">Active</a>
                                            <?php else: ?>
                                            <a class="btn btn-sm btn-danger" href="<?php echo e(route('departments.status',['id'=>$d->id,'status'=>1])); ?>">De Active</a>
                                            <?php endif; ?>
                                        </td>
                                        <th>
                                            <button  class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#EditModel<?php echo e($d->id); ?>" >Edit</button>
                                            <a href="<?php echo e(route('departments.delete', ['id' => $d->id])); ?>" class="btn btn-sm btn-danger delete-btn"
                                                onclick="event.preventDefault(); deleteConfirmation('<?php echo e(route('departments.delete', ['id' => $d->id])); ?>');">
                                                    Delete
                                            </a>
                                        </th>
                                    </tr>
                                    ...
                                    <div class="modal" id="EditModel<?php echo e($d->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form  class="ajax-form" data-action="<?php echo e(route('departments.edit',['id'=>$d->id])); ?>"  data-method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="mb-3">
                                                        <label for="exampleInputcategory1" class="form-label">Departments Name</label>
                                                        <input type="text" class="form-control" name="departments" id="addcategory" id="exampleInputcategory1" placeholder="Enter Departments Name" value="<?php echo e($d->name); ?>" required>
                                                    </div>
    ...
    <div class="modal" id="AddModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="top:200px">
                ...
                <div class="modal-body">
                    <form  class="ajax-form" data-action="<?php echo e(route('departments.create')); ?>"  data-method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="exampleInputcategory1" class="form-label">Departments Name</label>
...
<?php endif; ?><?php /**PATH /home/adxventure/lara_tms/resources/views/admin/department/index.blade.php ENDPATH**/ ?>