...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title','Fresh Sale'); ?>
        <!-- Flatpickr Timepicker css -->
    <link href="<?php echo e(asset('assets/vendor/datepicker/flatpickr.min.css')); ?>" rel="stylesheet" type="text/css" />
    <style>
        .col-3{
            float:right;
        }
...
<?php endif; ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <!-- filter Form Start -->
                        <form method="POST" action="<?php echo e(route('crm.freshsale.invoice')); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="client_id" value="<?php echo e($client->id); ?>">
                            <div class="row m-4">
                                <div class="col-md-3 mt-3">
                                    <label>Billing Date<span class="text-danger">*</span></label>
                                    <input class="form-control" type="date" name="billing_date" id="billing_date" value="<?php echo e($invoice->billing_date ?? ''); ?>" required>
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label>Client Gst No.</label>
                                    <input class="form-control" type="text" name="gst_no" placeholder="Enter Client Gst no." value="<?php echo e($invoice->client_gst_no ?? ''); ?>">  
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="exampleInputgstno2">Office<span class="text-danger">*</span></label>
                                    <select class="form-control" name="office">
                                        <option selected disabled>Select Office</option>
                                        <?php if(isset($invoice->office)): ?>
                                            ...
                                            <option value="<?php echo e($office->id); ?>" <?php if($office->id == $invoice->office ?? ''): ?> selected <?php endif; ?>> <?php echo e($office->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $offices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-control" name="gst" onchange="getBankDetail(this.value)">
                                        ...
                                        <option value="1" <?php if($invoice->Bank->gst = 1): ?> selected <?php endif; ?>>With Gst</option>
                                        <option value="0" <?php if($invoice->Bank->gst != 1): ?> selected <?php endif; ?>>Without Gst</option>
                                        <?php else: ?>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-control bankDetails" name="bank_details">
                                        <?php if(isset($invoice->Bank)): ?>  
                                            <option value="<?php echo e($invoice->Bank->id); ?>" selected><?php echo e($invoice->Bank->bank_name); ?></option>
                                        <?php else: ?>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="number" class="form-control" name="gst" id="gst" value="<?php echo e($invoice->gst ?? ''); ?>">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="discount" class="form-label">Discount</label>
                                    <input type="number" class="form-control" name="discount" id="discount" value="<?php echo e($invoice->discount ?? ''); ?>">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="" class="form-label">Currency<span class="text-danger">*</span></label>
                                    <select class="form-select" name="currency" required>
                                        <option selected disabled>Choose Currency</option>
                                        <?php if(isset($invoice->currency)): ?>
                                        <option value="$" <?php if($invoice->currency == "$"): ?>  selected <?php endif; ?>>USD ($)</option> 
                                        <option value="₹" <?php if($invoice->currency == "₹"): ?>  selected <?php endif; ?> >INR (₹)</option> 
                                        <option value="£" <?php if($invoice->currency == "£"): ?>  selected <?php endif; ?>>Pound (£)</option> 
                                        <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $invoice->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="row work-row mt-3">
                                            <div class="col">
                                                ...
                                                <input type="text" name="work_name[]" class="form-control" value="<?php echo e($service->work_name); ?>">
                                            </div>
                                            <input type="hidden" name="work_id[]" class="form-control" value="<?php echo e($service->id); ?>">
                                            <div class="col">
                                                <label>Work Quantity<span class="text-danger">*</span></label>
                                                <input type="number" name="quantity[]" class="form-control quantity" value="<?php echo e($service->work_quality); ?>">
                                            </div>
                                            <div class="col">
                                                <label>Work Price<span class="text-danger">*</span></label>
                                                <input type="number" name="price[]" class="form-control price" value="<?php echo e($service->work_price); ?>">
                                            </div>
                                            <div class="col">
                                                <label>Work Type<span class="text-danger">*</span></label>
                                                <select class="form-select" name="work_type[]">
                                                    <option value="One time" <?php if($service->work_type ="One time"): ?> selected <?php endif; ?>>One time</option>
                                                    <option value="Weekly" <?php if($service->work_type ="Weekly"): ?> selected <?php endif; ?>>Weekly</option>
                                                    <option value="Monthly" <?php if($service->work_type ="Monthly"): ?> selected <?php endif; ?>>Monthly</option>
                                                    <option value="3 Month" <?php if($service->work_type ="3 Month"): ?> selected <?php endif; ?>>3 Month</option>
                                                    <option value="6 Month" <?php if($service->work_type ="6 Month"): ?> selected <?php endif; ?>>6 Month</option>
                                                    <option value="Yearly" <?php if($service->work_type =" Yearly"): ?> selected <?php endif; ?>>Yearly</option>
                                                </select>
                                            </div>
    ...
    <script src="<?php echo e(asset('assets/vendor/datepicker/flatpickr.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/datepicker/form-picker.js')); ?>"></script>
    <script>
...
<?php endif; ?><?php /**PATH /home/bookmziw/adx_tms/laravel/resources/views/admin/crm/freshsale.blade.php ENDPATH**/ ?>