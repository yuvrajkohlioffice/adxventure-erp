...
<body>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="text-align: right;" colspan="2">
                                    <h3 style="margin: 0; color: #3989c6;">Bill <br>#00<?php echo e($invoice->id); ?>/<?php echo e(date('M', strtotime($invoice->created_at))); ?>/<?php echo e(date('Y', strtotime($invoice->created_at))); ?>-<?php echo e(date('y', strtotime($invoice->created_at)) + 1); ?></h3>
                                    <div>Date of Bill: <?php echo e(date('d/m/Y', strtotime($invoice->created_at))); ?></div>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td colspan="2" style="padding: 0 15px;">
                        <table>
                            ...
                            <tbody>
                                ...
                                <?php endif; ?>
                                    <tr>
                                        <td <?php if($bank->gst == 1): ?> rowspan="6" <?php else: ?> rowspan="4" <?php endif; ?>  style="border: 1px solid #ddd;"> </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" style="border: 1px solid #ddd;"><strong style="float: right;"><?php echo e($invoice->currency); ?> <?php echo e(number_format(($invoice->pay_amount ?? '00'))); ?>.00</strong></td>
                                    </tr> 
                                    <tr>
                                        <td style="border: 1px solid #ddd;text-align:right;" colspan="6" ><strong>Balance</strong></td>
                                        <td class="text-right" style="border: 1px solid #ddd;"><strong style="float: right;"><?php echo e($invoice->currency); ?> <?php echo e(number_format(($invoice->balance ?? '00'))); ?>.00</strong></td>
                                    </tr> 
                            </tbody>
 ...
 <?php /**PATH /home/adxventure/lara_tms/resources/views/admin/invoice/bill.blade.php ENDPATH**/ ?>