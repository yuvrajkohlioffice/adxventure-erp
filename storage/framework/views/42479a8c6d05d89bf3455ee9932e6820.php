                                    ...
                                    <main>
                                        <div class="row contacts">
                                            ...
                                            <div class="col invoice-details">
                                                ...
                                                <div class="date">Date of Bill : <?php echo e(date('d/m/Y', strtotime($invoice->created_at))); ?></div>
                                            </div>
                                        </div>
                                        <!-- Work Table  -->
                                            ...
                                            <tfoot>
                                                <tr style="background: #fff;">
                                                    ...
                                                    <td colspan="2" rowspan="1">
                                                        ...
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            Paid Amount :<span><strong
                                                                style="float: right"><?php echo e($invoice->currency); ?> <?php echo e(number_format(($invoice->pay_amount ?? '00'))); ?>.00</strong></span> 
                                                        </h5>
                                                    </td>
                                                </tr>
                                                <tr style="background:#fff;">
        ...
        <div class="modal-dialog  modal-dialog-centered ">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="leadModalLabel">Send Bill </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <form class="ajax-form" data-action="<?php echo e(route('bill',[$invoice->id])); ?>" data-method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
...
<?php endif; ?>
<?php /**PATH /home/adxventure/lara_tms/resources/views/admin/invoice/bill-preview.blade.php ENDPATH**/ ?>