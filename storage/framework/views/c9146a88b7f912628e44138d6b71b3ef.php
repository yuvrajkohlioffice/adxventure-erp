    ...
    <section class="section">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="<?php echo e(route('crm.quotation.client', ['id' => $id == 1 ? $invoice->client->id : $invoice->lead->id])); ?>" class="btn btn-sm btn-warning">Edit Proposal</a>
            </div>
        </div>
        <br><br>
        <div class="row">
                        ...
                        <div id="invoice">
                            <div class="invoice overflow-auto">
                                <div style="min-width: 600px">
                                    <header>
                                        <div class="row">
                                            ...
                                            <div class="col company-details">
                                                <div><?php echo e($invoice->Office->address); ?><br />
                                                    <?php echo e($invoice->Office->city); ?>

                                                    <?php echo e($invoice->Office->zip_code); ?> - <?php echo e($invoice->Office->state); ?></div>
                                                <div><b>Phone No.</b>: <?php echo e($invoice->Office->phone); ?></div>
                                                <div><b>Email </b>: <?php echo e($invoice->Office->email); ?></div>
                                                <?php if($bank->gst =='1'): ?>
                                        ...
                                        <div class="row contacts">
                                            ...
                                            <div class="col invoice-details">
                                                ...
                                                <div class="date">Date of Invoice :
                                                    <?php echo e(date('d/m/Y', strtotime($invoice->created_at))); ?></div>
                                            </div>
                                        </div>
                                        <!-- Work Table  -->
                                                ...
                                                <tr style="background: #fff;">
                                                    ...
                                                    <td colspan="2" rowspan="1">
                                                        <h5 style="border-bottom:1px solid ;padding: 10px 0;">
                                                          Subtotal<strong
                                                                style="float: right"><?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->subtotal_amount ?? 00)); ?>.00</strong>
                                                        </h5>
                                                        <?php if($bank->gst ==1): ?>
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            GST: <?php echo e($invoice->gst); ?>%<strong
                                                                style="float: right">
                                                                <?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->gst_amount ?? 00)); ?>.00</strong>
                                                        </h5>
                                                        <?php endif; ?>
                                                        <?php if($invoice->discount ?? 0): ?>
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                            Discount: <strong style="float: right">
                                                            <?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->discount ?? 00)); ?>.00</strong></h5>
                                                        <?php endif; ?> 
                                                        <h5 style="border-bottom:1px solid; padding: 10px 0;">
                                                           Total Amount :<span><strong
                                                                style="float: right"><?php echo e($invoice->currency); ?> <?php echo e(number_format(($invoice->total_amount ?? '00'))); ?>.00</strong></span> 
                                                        </h5>
                                                    </td>
                                                </tr>
                                                <tr style="background:#fff;">
                                    ...
                                    <footer>
                                        Bill Generate By AdxVenture- <?php echo e(Date('Y')); ?> | <a href="https://adxventure.com/"
                                            target="_blank">www.adxventure.com</a>

                                            <a style="float:right">Created By: <?php echo e($invoice->user->name ?? Auth::User()->name); ?></a>
                                    </footer>
                                </div>
                                <div>
                                </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content" style="top:220px">
                ...
                <div class="modal-body">
                    <form id="ajax-form" data-action="<?php echo e(route('crm.prposel.mail', ['invoiceId' => $invoice->id, 'id' => $id == 1 ? 1 : null])); ?>" data-method="POST">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /home/bookmziw/adx_tms/laravel/resources/views/admin/crm/prposal/mail_preview.blade.php ENDPATH**/ ?>