...
<?php $component->withAttributes([]); ?>
    ...
    <div class="pagetitle">
        ...
        <h1>Task - Project : <?php echo e($data->project->name ?? ''); ?> </h1>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form autocomplete="off" data-method="POST" data-action="<?php echo e(route('task.update',$data->id)); ?>" id="ajax-form" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="project_id" value="<?php echo e($data->project_id); ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category">
                                            ...
                                            <option value="1" <?php if($data->category == "1"): ?> selected <?php endif; ?> >Normal</option>

                                            <option value="2" <?php if($data->category == "2"): ?> selected <?php endif; ?> >Medium</option>

                                            <option value="3" <?php if($data->category == "3"): ?> selected <?php endif; ?> >High</option>

                                            <option value="4" <?php if($data->category == "4"): ?> selected <?php endif; ?> >Urgent</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="type" id="type">
                                            ...
                                            <option value="1" <?php if($data->type == "1"): ?> selected <?php endif; ?> >Daily</option>

                                            <option value="4" <?php if($data->type == "4"): ?> selected <?php endif; ?> >Once</option>

                                            <option value="2" <?php if($data->type == "2"): ?> selected <?php endif; ?> >Weekly</option>

                                            <option value="3" <?php if($data->type == "3"): ?> selected <?php endif; ?> >Monthly</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group type">
                                        ...
                                        <input class="form-control"  id="datePick" value="<?php echo e($userDate ?? ''); ?>" name="assign_dates" />
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="exampleInputEmail2" value="<?php echo e($data->deadline); ?>" name="deadline">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputEmail2" value="<?php echo e($data->estimated_time); ?>" name="estimated_time" placeholder="Enter Estimate time..">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if(count($aUsers->users) > 0): ?>

                                        <?php $__currentLoopData = $aUsers->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <input type="checkbox" name="executive[]" value="<?php echo e($user->id); ?>" <?php if(in_array($user->id,$usersIds)): ?> checked <?php endif; ?> > &nbsp; <?php echo e($user->name); ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="x" type="hidden" value="<?php echo e($data->description); ?>" name="description">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="exampleInputEmail2" name="attachment" <?php if($data->attachment == 1): ?> checked <?php endif; ?> />
                                        ...
                                        <input type="checkbox" id="exampleInputEmail2" name="remark" <?php if($data->remark_needed == 1): ?> checked <?php endif; ?> />

                                        <small id="error-remark" class="form-text error text-muted"></small>

                                        <label for="exampleInputEmail1">Url:</label> &nbsp; &nbsp;

                                        <input type="checkbox" id="exampleInputEmail2" name="url" <?php if($data->url == 1): ?> checked <?php endif; ?> />
...
<?php endif; ?><?php /**PATH /home/adxventure/lara_tms/resources/views/admin/tasks/edit.blade.php ENDPATH**/ ?>